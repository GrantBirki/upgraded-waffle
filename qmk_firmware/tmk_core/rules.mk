...
cpfirmware: $(FIRMWARE_FORMAT)
	...
	$(SILENT) || printf "Copying $(TARGET).$(FIRMWARE_FORMAT) to output folder" | $(AWK_CMD)
	$(COPY) $(BUILD_DIR)/$(TARGET).$(FIRMWARE_FORMAT) /output/$(TARGET).$(FIRMWARE_FORMAT).output && $(PRINT_OK)
